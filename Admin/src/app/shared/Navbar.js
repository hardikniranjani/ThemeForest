            ...
            <Dropdown alignRight>
              <Dropdown.Toggle className="nav-link">
                ...
                <div className="nav-profile-text">
                  {Admin && <p className="mb-1 text-black"><Trans>{Admin.name}</Trans></p>}
                </div>
              </Dropdown.Toggle>
              ...
              <Dropdown.Menu className="navbar-dropdown">
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()}>
                  ...
                  <Link to="/account" className="text-decoration-none text-body">Account</Link>
                </Dropdown.Item>
                <Dropdown.Item href="!#" onClick={(e) => HandlSignOut(e)}>
